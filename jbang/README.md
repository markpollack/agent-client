...
jbang catalog add --name=springai \
  https://raw.githubusercontent.com/markpollack/agent-client/main/jbang-catalog.json
...
```bash
jbang https://raw.githubusercontent.com/markpollack/agent-client/main/jbang/launcher.java \
  hello-world \
  path=greeting.txt \
...
```bash
# Add the catalog
jbang catalog add springai https://raw.githubusercontent.com/markpollack/agent-client/main/jbang-catalog.json
