...
package io.github.markpollack.agents.advisors.judge;
 ...
 * {@link io.github.markpollack.judge.result.Judgment}</li>
 * <li>{@code verdict.pass} - Boolean indicating pass/fail based on aggregated
 * judgment</li>
 * <li>{@code verdict.status} - The
 * {@link io.github.markpollack.judge.result.JudgmentStatus}</li>
 * </ul>
 *
 * @author Mark Pollack
 * @since 0.1.0
